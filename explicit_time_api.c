...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 12), // void()(double *, int, int, double, double const *, int, double, double, double, double const *)
...
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // double const *
...
static void _cffi_d_explicit_time(double * x0, int x1, int x2, double x3, double const * x4, int x5, double x6, double x7, double x8, double const * x9)
{
  explicit_time(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_explicit_time(PyObject *self, PyObject *args)
{
  double * x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "explicit_time", 10, 10, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9))
    return NULL;
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x9 = (double const *)alloca((size_t)datasize);
...
#else
#  define _cffi_f_explicit_time _cffi_d_explicit_time
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "explicit_time", (void *)_cffi_f_explicit_time, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_explicit_time },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_explicit_time_api(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_explicit_time_api(void) { return NULL; }
#  else
     initexplicit_time_api(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_explicit_time_api(void)
{
  return _cffi_init("explicit_time_api", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initexplicit_time_api(void)
{
  _cffi_init("explicit_time_api", 0x2601, &_cffi_type_context);
}
#endif
